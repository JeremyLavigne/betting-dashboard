const championshipList = [
    ...
    },
    {
        ...
        minOdd: [1, 0, 0],
        maxOdd: [2.3, 0, 0],
        equationsH: [[0, 0.15, 0.46], [0.01, 0.17, 0.46], []],
        equationsD: [[], [], []],
        equationsA: [[], [], []],
        fullSeason: [[], [], [2.4, 2.7]],
        firstHalf: [[2.9, 3.5], [], []],
        secondHalf: [[], [3, 3.2], []],
        firstQuarter: [[2.6, 2.9], [3.6, 4.2], []],
        secondQuarter: [
            [2, 2.3],
            [3.4, 3.6],
            [2.1, 2.4],
    ...
    {
        id: 'G1',
        name: 'Greece S. League',
        path: 'super-league',
        country: 'greece',
        season: '2021',
        numberOfMatchSeason: 182,
        minOdd: [0, 0, 0],
        maxOdd: [0, 0, 0],
        equationsH: [[], [], []],
        equationsD: [[], [], []],
        ...
        secondQuarter: [[1.7, 2], [3.4, 3.6], []],
        thirdQuarter: [[], [], []],
        lastQuarter: [[], [3, 3.2], [1.8, 2.4]],
        teamsCheck: [
    ...
    },
    {
        ...
        maxOdd: [0, 5.2, 0],
        equationsH: [[], [], []],
        equationsD: [[-0.02, -0.01, 0.24], [-0.02, 0, 0.25], []],
        equationsA: [[], [], []],
        fullSeason: [[], [], []],
        firstHalf: [[], [4.2, 4.4], []],
        secondHalf: [[3.2, 3.8], [], [3.6, 3.9]],
        firstQuarter: [[], [], [1.8, 2.4]],
        secondQuarter: [
            [1.7, 2.2],
            [3, 3.4],
            [3, 3.3],
        ],
        thirdQuarter: [[2, 3.2], [], [2.7, 3]],
        lastQuarter: [[2, 2.3], [], [2.4, 3]],
        teamsCheck: [
            ['PSV', 'PSV Eindhoven'],
            ['Sittard', 'For Sittard'],
            ['Venlo', 'VVV Venlo'],
    ...
    },
    {
        ...
        fullSeason: [[], [], []],
        firstHalf: [[], [], []],
        secondHalf: [[], [4, 4.4], [3, 3.3]],
        firstQuarter: [[2.3, 2.6], [3.4, 4], []],
        secondQuarter: [[], [3.2, 3.4], [3.6, 3.9]],
        thirdQuarter: [[], [], [1.8, 2.4]],
        lastQuarter: [[1.7, 2], [], [2.7, 3]],
        teamsCheck: [
            ['FC Porto', 'Porto'],
            ['Sporting', 'Sp Lisbon'],
            ['Braga', 'Sp Braga'],
    ...
    },
    {
        ...
        country: 'turkey',
        season: '2021',
        numberOfMatchSeason: 420,
        minOdd: [1, 3, 0],
        maxOdd: [1.6, 4.8, 0],
        equationsH: [[0, 0.12, 0.46], [-0.01, 0.12, 0.49], []],
        equationsD: [[-0.03, -0.02, 0.28], [-0.03, 0, 0.25], []],
        equationsA: [[], [], []],
        fullSeason: [[], [], []],
        firstHalf: [[], [], []],
        secondHalf: [[2.3, 2.6], [], [2.1, 2.4]],
        firstQuarter: [[2.3, 3.2], [3.6, 4], []],
        secondQuarter: [[], [3.4, 3.6], [1.8, 2.4]],
        thirdQuarter: [[2, 2.3], [3.6, 4], []],
        lastQuarter: [[], [], [3, 3.3]],
        teamsCheck: [
            ['Goztepe', 'Goztep'],
